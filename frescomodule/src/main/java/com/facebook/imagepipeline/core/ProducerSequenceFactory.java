...
public class ProducerSequenceFactory {
  ...
  public ProducerSequenceFactory(
    ...
    mDownsampleEnabled = downsampleEnabled;
        mPostprocessorSequences = new HashMap<Producer<CloseableReference<CloseableImage>>, Producer<CloseableReference<CloseableImage>>>();
        mCloseableImagePrefetchSequences = new HashMap<Producer<CloseableReference<CloseableImage>>, Producer<Void>>();
  }
