...
public class CountingMemoryCache<K, V> implements MemoryCache<K, V>, MemoryTrimmable {
  ...
  public CountingMemoryCache(
    ...
    mValueDescriptor = valueDescriptor;
        mExclusiveEntries = new CountingLruMap<K, Entry<K, V>>(wrapValueDescriptor(valueDescriptor));
        mCachedEntries = new CountingLruMap<K, Entry<K, V>>(wrapValueDescriptor(valueDescriptor));
