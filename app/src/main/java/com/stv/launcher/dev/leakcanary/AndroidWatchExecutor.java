 ...
 * {@link com.example.sdpc.myapplication.R.integer#leak_canary_watch_delay_millis} seconds.
 */
public final class AndroidWatchExecutor implements Executor {
  ...
  void executeDelayedAfterIdleUnsafe(final Runnable runnable) {
    ...
    //Because the main thread has a Looper.
    //if there is no Looper ,this method will throw an exception
