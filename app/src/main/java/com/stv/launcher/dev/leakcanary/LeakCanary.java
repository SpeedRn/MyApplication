 ...
 */
package com.stv.launcher.dev.leakcanary;
...
import com.stv.launcher.dev.analyzer.leakcanary.AnalysisResult;
import com.stv.launcher.dev.leakcanary.internal.DisplayLeakActivity;
import com.stv.launcher.dev.leakcanary.internal.HeapAnalyzerService;
import com.stv.launcher.dev.watcher.DebuggerControl;
import com.stv.launcher.dev.watcher.ExcludedRefs;
import com.stv.launcher.dev.watcher.GcTrigger;
import com.stv.launcher.dev.watcher.HeapDump;
import com.stv.launcher.dev.watcher.RefWatcher;
import com.example.sdpc.myapplication.R;

import static android.text.format.Formatter.formatShortFileSize;
import static com.stv.launcher.dev.leakcanary.internal.LeakCanaryInternals.isInServiceProcess;
import static com.stv.launcher.dev.leakcanary.internal.LeakCanaryInternals.setEnabled;
...
public final class LeakCanary {
  ...
  public static RefWatcher install(Application application,
    ...
    //TODO add a judge to make a switch for leak monitoring.

    if (isInAnalyzerProcess(application)) {
      return RefWatcher.DISABLED;
    }
    //TODO for LETV We don't enable another Main Activity
