...
import com.stv.launcher.dev.leakcanary.internal.RequestStoragePermissionActivity;
...
import static com.stv.launcher.dev.leakcanary.internal.LeakCanaryInternals.showNotification;
...
//    File downloadsDirectory = Environment.getExternalStoragePublicDirectory(DIRECTORY_DOWNLOADS);
  ...
  @Override public void requestWritePermissionNotification() {
    ...
    String contentTitle = context.getString(com.example.sdpc.myapplication.R.string.leak_canary_permission_notification_title);
    CharSequence packageName = context.getPackageName();
    String contentText =
        context.getString(com.example.sdpc.myapplication.R.string.leak_canary_permission_notification_text, packageName);
